...
[Abrir la guía imprimible en PDF](output/pdf/guia_objetos_referencias.pdf) · [Leer en Markdown](guia_objetos_referencias.md)
...
| Ubicación | Uso |
| --- | --- |
| [output/pdf/guia_objetos_referencias.pdf](output/pdf/guia_objetos_referencias.pdf) | Guía de 43 páginas, tamaño carta, con fuentes incorporadas y marcadores de navegación. |
...
El Markdown, el PDF, los SVG y los scripts de estudiantes son archivos generados. Para mantenerlos sincronizados, modifica la fuente y vuelve a generar el material.
...
Revisa especialmente bloques de código completos, flechas de los diagramas, espacios para responder y saltos de página. El índice actual corresponde a 43 páginas; actualiza este dato en los README si cambia la extensión.
